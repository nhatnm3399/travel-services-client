        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-slide-description">
            ...
            <div className={"dsjkdsjfkdsadas"} style={{display: "flex", justifyContent: "center", alignItems: "center", position: "relative"}}>
                <input value={`${moment(props?.startDate).format("DD-MM-YYYY")} - ${moment(props?.endDate).format("DD-MM-YYYY")}`} onClick={()=> setOpenPicker(prev=> !prev)} type="text" placeholder="Chọn khoảng thời gian" style={{width: 300, height: 25.2, outlineColor: "#2e89ff", }} />
                {
